            ...
            <div class="content" id="remindersContent" style="display: block;">
                <div class="info-center">
                    <div class="grid-container">
                        <a href="myKnowledgeReminders.php" style="text-decoration:none; color: inherit;" 
                            class="grid-item">MY KNOWLEDGE REMINDERS
                        </a>
                        <a href="/PKMS/PKMS(Manager)/ProdRemindersLanding.php" style="text-decoration:none; color: inherit;" 
                            class="grid-item">MY PRODUCTIVITY REMINDERS
                        </a>
                    </div>
                </div>
            </div>
