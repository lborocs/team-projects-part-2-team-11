            ...
            <div class="content" id="content3" style="display: contents;">
                        <div class="info-center">
                            <ul class="breadcrumbs">
                                ...
                                <li class="breadcrumbs-item">
                                    <a href="contentHub.php" class="breadcrumbs_link--active">My Hub</a>
                                </li>
                            </ul>
                            <div class="grid-container">
                                <a href="myPosts.php" style="text-decoration:none; color: inherit;" 
                                    class="grid-item">MY POSTS
                                </a>
                                <a href="myFavourites.php" style="text-decoration:none; color: inherit;" 
                                    class="grid-item">MY FAVOURITES
                                </a>
                            </div>
                        </div>
            </div>
